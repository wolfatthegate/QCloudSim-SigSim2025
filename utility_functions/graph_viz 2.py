...
def display_graph(QDevice, figsize=(5, 3), title = ''):
    """
    ...
    nx.draw_networkx(QDevice.graph, QDevice.pos, node_color=QDevice.color_map, with_labels=True, node_size=700, font_size=8)
